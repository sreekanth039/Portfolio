            ...
            return (
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`flex items-center space-x-3 ${
                        isRight ? 'md:flex-row-reverse md:space-x-reverse' : ''
                      }`}
                    >
                  ...
                  <h4 className="text-lg font-medium text-blue-400 mb-4">{experience.company}</h4>

                  {/* ✅ FIXED BULLETS FOR RIGHT-SIDE CARDS */}
                  <ul className={`space-y-2 mb-6 ${isRight ? 'md:text-right' : ''}`}>
                      ...
                      >
                        <span
                          className={`w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0 ${
                            isRight ? 'md:ml-3 md:mr-0' : 'mr-3'
                          }`}
                        />
                        <span className={isRight ? 'md:text-right' : ''}>{item}</span>
                      </li>
                    ))}
                  </ul>

                  {/* Optional: align tech chips with card side */}
