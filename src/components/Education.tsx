  ...
  const education = [
    {
      ...
      description: [
       'Built 10+ sprint features across e-commerce, healthcare, and AI projects',
    'Implemented search, filtering, pagination, authentication, and cart features',
    'Integrated REST APIs using Axios with loading and error handling',
    'Used ChatGPT and Cursor for debugging, refactoring, and faster development',
      ],
